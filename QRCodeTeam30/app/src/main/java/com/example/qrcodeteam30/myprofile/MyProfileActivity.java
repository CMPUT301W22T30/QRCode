...
public class MyProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textViewInfo = findViewById(R.id.textView_myprofile_info);
        ...
        Button buttonEstimateRanking = findViewById(R.id.button_myProfile_myRanking);
        ImageView imageView = findViewById(R.id.MyProfileImageView);

        FirebaseFirestore db = FirebaseFirestore.getInstance();
        final CollectionReference collectionReferenceSignInInformation = db.collection("SignInInformation");
